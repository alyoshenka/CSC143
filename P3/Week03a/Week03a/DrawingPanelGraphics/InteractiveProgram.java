...
/**
 * Gathering user data to draw a graphical box
 * 
 * @author      Bill Barry 
 * @version     2017-01-12
 */
public class InteractiveProgram {
    ...
    public static void main(String[] args) {
        ...
        drawRectangle(50, 75, boxWidth, boxHeight, Color.RED, dpg);
    ...
    public static void drawRectangle(int startX, int startY, int width, int height, Color rectColor, Graphics dpg) {
        dpg.setColor(rectColor);
        dpg.fillRect(startX, startY, width, height);
    }
}
